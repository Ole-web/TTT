...
class Game {
  ...
  createPlayers() {
    ...
    const player1Name =
      player1Input.trim().length > 0 ? player1Input : "Player 1";
    ...
    if (this.vsComputer) {
      ...
      const player2Name =
        player2Input.trim().length > 0 ? player2Input : "Player 2";
      player2 = new Player(player2Name, "player2", "#3688C3", !p1Active);
    }
    return [new Player(player1Name, "player1", "#FFA000", p1Active), player2];
  }
